...
# D. Total Reward Progressions
do_plot(total_raw, "Global Distributed Cumulative Reward", "Testing Episode Reward", "Total_Rewards_Comparison_Normal.png", x_log=False)
do_plot(total_raw, "Global Distributed Cumulative Reward (Log Scale)", "Testing Episode Reward", "Total_Rewards_Comparison_Log.png", x_log=True)
