...
def get_common_args():
    ...
    parser.add_argument('--federated', type=str2bool, default=False, help='whether trian the algorithm with federated learning')
    ...
    parser.add_argument('--model', type=str2bool, default=False, help='whether use the model')
    ...
    parser.add_argument('--priority', action='store_true', default=False, help='Enable priority-aware mode (True=Proposed, False=Baseline)')
